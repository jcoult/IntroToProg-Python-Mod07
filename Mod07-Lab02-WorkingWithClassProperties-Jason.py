# ------------------------------------------------- #
# Title: Lab02 - Working with Properties
# # Description: Demonstrates how to use class Properties
# ChangeLog: (Who, When, What)
# RRoot,1.1.2030,Created Script
# RRoot,1.2.2030,Converted dictionary rows to student class objects.
# <YourNameHere>,<CurrentDate>,Added properties and private attributes
# ------------------------------------------------- #
import json
...
class Student:
    ...
    def first_name(self, value: str):
        if value.isalpha() or value == "":
            ...
            raise ValueError("The first name shouldn't contain numbers!")
    ...
    def last_name(self, value: str):
        if value.isalpha() or value == "":  # Only if letters or blank
            self.__last_name = value
        else:
            raise ValueError("The last name shouldn't contain numbers!")

    # TODO 4. Add a getter and setter properties for the private attribute __gpa
    @property
    def gpa(self):  # Getter for GPA
        return self.__gpa
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        #     # TODO 6. Add code to create a new student object using each property's validation code
            student = Student()  # Create student with defaults
            ...
            student_data.append(student)  # Add new student to list
