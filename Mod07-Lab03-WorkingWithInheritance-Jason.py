...
# <YourNameHere>,<CurrentDate>,Added Inheritance
# ------------------------------------------------- #
import json
...
# TODO 3 Create property getter and setter for first name using the same code as in the Student class
    @property  # Getter
    def first_name(self):
        return self.__first_name.title()  # Formatting

    @first_name.setter
    def first_name(self, value: str):
        if value.isalpha() or value == "":  # Require text or empty string
...
# TODO 4 Create property getter and setter for last name using the same code as in the Student class
    ...
    @property
    def last_name(self):
        return self.__last_name.title()  # Formatting
    ...
    def __str__(self):  # Override this method to show info about the Person
...
class Student(Person):  # Inherit from Person class
    ...
    def __init__(self, first_name: str = '', last_name: str = '', gpa: float = 0.00):
        #self.first_name = first_name
        #self.last_name = last_name
        super().__init__(first_name = first_name, last_name = last_name)  # Inherits from superclass Person
        self.gpa = gpa
    ...
    def __str__(self):  # Override with custom
